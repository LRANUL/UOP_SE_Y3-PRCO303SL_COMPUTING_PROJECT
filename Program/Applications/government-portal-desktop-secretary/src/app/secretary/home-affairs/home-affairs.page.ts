...
export class HomeAffairsPage implements OnInit {
  ...
  async getNICApplications() {
    ...
    setTimeout(() => {
      this.accessService.getEApplications(this.Division).subscribe((data) => {
        // console.log(data);
      ...
      inputs: [
        {
          ...
          value: "Form Not Valid / Incorrect",
        },
        {
          name: "PhoneFailed",
          type: "radio",
          label: "Phone Verification Failed",
          value: "Phone Verification Failed",
        },
        {
          name: "FakeData",
          type: "radio",
          label: "Form Data Mismatch",
          value: "Form Data Mismatch / Third Party Attempt",
        },
        {
          name: "photoFail",
          type: "radio",
          label: "Photo Mismatch",
          value: "Photo Mismatch / Third Party Attempt",
        },
      ],
      buttons: [
        {
